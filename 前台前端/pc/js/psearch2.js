...
var psvm = new Vue({
	...
	mounted: function(){
		this.$nextTick(function(){
			var oa = (getSession("pa")==null)?0:parseInt(getSession("pa"))
			var ob = (getSession("pb")==null)?0:parseInt(getSession("pb"))
			var oc = (getSession("pc")==null)?0:parseInt(getSession("pc"))
			console.log(oa)
			console.log(ob)
			console.log(oc)
			Vue.set(this.clarr,"a",oa)
			Vue.set(this.clarr,"b",ob)
			Vue.set(this.clarr,"c",oc)
	...
	methods:{
		onSearch: function(){
			...
			this.searchObj.p = (getSession("p")===null)?"1":getSession("p");
		...
		getEventBySearch: function(){
			...
			if(st === "" && et === "" || st === null && et === null || st === "null" && et === "null"){
